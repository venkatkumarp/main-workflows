...
terraform {
  ...
  backend "s3" {
    ...
    # Uncomment the following line if using state locking with DynamoDB
    # dynamodb_table = "terraform-lock-table" 
  }
}

###########################################
# Data source to fetch the S3 object (zip file)
...
# IAM policy to allow basic Lambda execution
